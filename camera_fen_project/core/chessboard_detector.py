...
class ChessboardDetector:
    ...
    def extract_chessboard_and_classifier_layout(self, 
        ...
        # 预测每个位置的 棋子类别
        # 返回: label_names_10x9, label_short_10x9, confidence_10x9, layout_str
        _, label_short_10x9, confidence_10x9, _ = self.full_classifier.pred(transformed_image_copy, is_rgb=True)

        return transformed_image, label_short_10x9, confidence_10x9
            ...
            for col in range(9):
                ...
                if piece == '.' or piece == 'point':
                    ...
                    if score < threshold:
                        ...
                        # board_matrix 已经是短标签（如 'K', 'R', 'P'），直接使用
